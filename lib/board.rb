...
# The Board class represents the chess board and provides methods to manage
# the state of the board, including piece placement, movement, and validation
# of moves. It ensures the rules of chess are followed.
class Board
  attr_reader :grid
  ...
  def move_piece(start_pos, end_pos)
    ...
    raise InvalidMoveError.new('End position not in bounds.') unless in_bounds?(end_pos)
